...
define('PHIE_URL', "https://www.pharmacielereste.fr");
...
<head>
    ...
    <title><?= NOM_PHARMA ?> - Erreur 401</title>
...
<body>
    <header>
        <section class='cBraille'>Erreur 401 : 'utilisateur non authentifié'.
    ...
    <main id='iMain'>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>Erreur 401 : 'utilisateur non authentifié'.</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
