...
// clients dont la dernière connexion remonte à 1 an ou plus : après les avoir prévenus, et on les supprime
...
foreach ($clients as $client) {
    ...
    if( $requete->execute() != true ){
        ...
        // (https://logs.cluster021.hosting.ovh.net/pharmacielereste.fr/)
